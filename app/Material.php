...
class Material extends Model
{
    ...
    protected $fillable = [
        "name", "category_id","selvage","construction", "color","color_no","article_no",'width','weight', "image", "barcode", "description", "min_alert_qty", "status","wholesale_price","retail_price","sample_price"
    ];
