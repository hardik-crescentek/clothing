...
class PurchaseItemController extends Controller
{
    ...
    {  
        ...
        return redirect()->route('purchase-item.create')->with('success', 'Purchase items added successfully');
    }
    ...
    public function update(Request $request, Purchase $purchase)
    {
        ...
        return redirect()->route('purchase-item.create')->with('success', 'Purchase items updated successfully');
    }
    ...
    // Method to get the purchase ID based on the invoice number
    ...
    public function getPurchaseItemsByInvoice(Request $request)
    {
        $invoice_no = $request->input('invoice_no');
