    ...
    <div class="col-xl-12 col-12">
        <div class="widget has-shadow">
            ...
            <div class="widget-body">
                ...
                {!! Form::open(array('route' => 'color.store','method'=>'POST', 'class'=>"form-validate", 'novalidate')) !!}
                ...
                <div class="form-group row d-flex align-items-center mb-5">
                    ...
                    <div class="col-lg-5">
                        {!! Form::text('code', '#000000', array('placeholder' => '#000000','class' => 'form-control', 'data-validation'=>"required")) !!}
                    </div>
                </div>
                <div class="form-group row d-flex align-items-center mb-5">
