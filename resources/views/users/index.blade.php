            ...
            <div class="widget-body">
                ...
                <div class="form-group row d-flex align-items-center mt-3">
                    ...
                    <label class="form-control-label">Role</label>
                        {!! Form::select('role', $roles,$selected_role, array('class' => 'form-control custom-select', 'onchange'=>'this.form.submit()')) !!}
                    </div>
                    <div class="col-lg-3">
                    ...
                    <table class="table table-hover mb-0 " id="user_tbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    <a class="btn btn-primary btn-sm btn-square col-sm-3 mt-1" href="{{ route('users.edit',$user->id) }}">Edit</a>
                                    {!! Form::open(['method' => 'DELETE','route' => ['users.destroy', $user->id],'style'=>'display:inline', 'onsubmit'=>'return delete_confirm()']) !!}
